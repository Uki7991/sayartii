...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    monthAndYear: function monthAndYear() {
      return moment__WEBPACK_IMPORTED_MODULE_2___default()().format('MMMM YYYY');
    }
  },
  data: function data() {
    return {
      weekday: moment__WEBPACK_IMPORTED_MODULE_2___default()().format('dddd'),
      day: moment__WEBPACK_IMPORTED_MODULE_2___default()().format('D'),
      interval: null
    };
  },
  mounted: function mounted() {
    ...
    this.interval = setInterval(function () {
      _this.day = moment__WEBPACK_IMPORTED_MODULE_2___default()().format('D');
      _this.weekday = moment__WEBPACK_IMPORTED_MODULE_2___default()().format('dddd');
    }, 1000 * 60 * 60);
  },
  destroyed: function destroyed() {
    clearInterval(this.interval);
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "grid grid-cols-12 gap-5" },
    [
      _c("card", { staticClass: "flex flex-col col-span-2" }, [
        _c("p", { staticClass: "text-2xl text-gray-900" }, [
          _vm._v("Calendar")
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "flex space-x-1 mt-auto" }, [
          _c("p", { staticClass: "text-6xl text-orange-500 font-medium" }, [
            _vm._v(_vm._s(_vm.day))
          ]),
          _vm._v(" "),
          _c("div", [
            _c("p", { staticClass: "text-lg text-gray-500 font-light" }, [
              _vm._v(_vm._s(_vm.monthAndYear))
            ]),
            _vm._v(" "),
            _c("p", { staticClass: "text-2xl text-gray-500" }, [
